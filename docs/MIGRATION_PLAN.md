...
Validation:
- vector similarity queries return stable top-k for fixed embeddings
- graph traversal queries return deterministic context neighborhoods
- replay validation passes with Neo4j-backed retrieval enabled
